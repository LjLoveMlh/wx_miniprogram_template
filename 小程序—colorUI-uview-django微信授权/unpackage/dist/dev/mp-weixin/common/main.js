...
/* 0 */
/*!***********************************************!*\
  !*** /Users/lovemm/Desktop/考级小程序_new/main.js ***!
  \***********************************************/
...
var _store = _interopRequireDefault(__webpack_require__(/*! @/common/store */ 15));

var _uviewUi = _interopRequireDefault(__webpack_require__(/*! @/common/uview-ui */ 17));
...
var _httpInterceptor = _interopRequireDefault(__webpack_require__(/*! @/common/http/http.interceptor.js */ 35));



var _httpApi = _interopRequireDefault(__webpack_require__(/*! @/common/http/http.api.js */ 36));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}var cuCustom = function cuCustom() {__webpack_require__.e(/*! require.ensure | common/colorui/components/cu-custom */ "common/colorui/components/cu-custom").then((function () {return resolve(__webpack_require__(/*! @/common/colorui/components/cu-custom.vue */ 44));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};_vue.default.component('cu-custom', cuCustom);_vue.default.config.productionTip = false;_App.default.mpType = 'app'; // 此处为演示vuex使用，非uView的功能部分
_vue.default.use(_uviewUi.default); // 引入uView提供的对vuex的简写法文件
var vuexStore = __webpack_require__(/*! @/common/store/$u.mixin.js */ 37);_vue.default.mixin(vuexStore);var app = new _vue.default(_objectSpread({ store: _store.default }, _App.default)); // http拦截器，将此部分放在new Vue()和app.$mount()之间，才能App.vue中正常使用
...
/* 5 */
/*!***********************************************!*\
  !*** /Users/lovemm/Desktop/考级小程序_new/App.vue ***!
  \***********************************************/
/*! no static exports found */
...
/* 6 */
/*!************************************************************************!*\
  !*** /Users/lovemm/Desktop/考级小程序_new/App.vue?vue&type=script&lang=js& ***!
  \************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var _httpToken = _interopRequireDefault(__webpack_require__(/*! common/http/http.token.js */ 8));
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 2));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _default =
{
  ...
  methods: {
    ...
    // 检查本地信息
    checkLocalToken: function checkLocalToken() {var _this = this;
      if (!_httpToken.default.has_token()) {
        ...
        //检查token是否有效
        _httpToken.default.check_token().then(function (res) {
          if (res) {
            // token 有效
            _this.userInfoInit();
          } else {
            // token 失效
            _httpToken.default.refresh_token().then(function (res) {
              _this.userInfoInit();
            });
          }
        });
    ...
    //用户信息初始化
    userInfoInit: function userInfoInit() {
      var that = this;
      uni.showLoading({
        title: "正在准备数据" });
...
/* 12 */
/*!********************************************************************************!*\
  !*** /Users/lovemm/Desktop/考级小程序_new/App.vue?vue&type=style&index=0&lang=css& ***!
  \********************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 13 */
/*!************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--6-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--6-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--6-oneOf-1-2!./node_modules/postcss-loader/src??ref--6-oneOf-1-3!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/lovemm/Desktop/考级小程序_new/App.vue?vue&type=style&index=0&lang=css& ***!
  \************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
